<template>
  <div
    class="map__wrapper"
    v-bind:class="{ 'map__wrapper--small': mapStatusIsSmall }"
  >
    <div
      class="map__toggle"
      @click="toggleMapStatus"
      v-bind:class="{ 'map__toggle--min': mapStatusIsSmall }"
    ></div>
    <MglMap
...
export default {
  data() {
    return {
      ...
      accessToken:
        "pk.eyJ1IjoidGR3ZXN0ZW4iLCJhIjoiY2s0cjZzY2dpMG1ncjNtcDU1c2djZmFtMSJ9.LNcjlixQe9Kn4DkKRmxlhQ",
